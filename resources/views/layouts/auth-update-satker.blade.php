                  ...
                  <div class="card text-right">
                      ...
                      <div class="card-body">
                          <div class="basic-form">
                              <form>
                                  <div class="col-md-6" style="right: 14px;">
                                    <div class="row">
                                      <img src="hai.png" class="ha">
                                      <label class="col-sm-3 col-form-label" style="margin-left: -47px; display: flex;">Tahun Anggaran*</label>
                                  ...
                                  <div class="col-md-6" style="right: 14px;">
                                    <div class="row">
                                      <img src="hai.png" class="ha">
                                      <label class="col-sm-3 col-form-label" style="margin-left: -57px;">SATKER</label>
                                      <div class="col" style="padding-right: 1px; margin-left: 59px;">
                                        <select id="collapsible-state" class="select2 form-select" data-allow-clear="true">
                                  ...
                                  <div class="mb-3 row">
                                    <div class="col-md-6">
                                      <div class="row">
                                      <img src="hai.png" class="ha">
                                      <label class="col-sm-3 col-form-label" style="margin-left: -20px;">Judul Laporan</label>
                                  ...
                                  <div class="col-md-8" style="right: 14px;">
                                    <div class="row">
                                      <img src="hai.png" class="ha">
                                      <label class="col-sm-3 col-form-label" style="margin-left: -47px;">Tempat/Tanggal</label>
                                      <div class="col" style="padding-right: 8px; margin-left: -52px;">
                                        <select id="collapsible-state" class="select2 form-select" data-allow-clear="true" style="margin-left: 54px;">
                                  ...
                                  <br>
                                  <div class="mb-3 row" style="left: 200px;">
                                    <div class="col-md-6">
                                        <div class="row">
                                          <img src="hai.png" class="ha">
                                          <label class="col-sm-3 col-form-label" style="margin-left: -25px;">
