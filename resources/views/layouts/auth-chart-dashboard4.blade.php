<?php
// Contoh variabel dengan URL dinamis
$tujuan_url = "http://127.0.0.1:8000/dashboard4";
?>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1 sayang">
            <!-- Dashboards -->
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle" style="margin-top: 10px;">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('dashboard') }}" class="menu-link">
                    <i class="menu-icon tf-icons mdi mdi-home-outline" style="color: white;"></i>
                    <div style="color: white; margin-left: 10px;"> Dashboard 1</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="app-invoice-preview.html" class="menu-link">
                    <i class="menu-icon tf-icons mdi mdi-home-outline" style="color: white;"></i>
                    <div style="color: white; margin-left: 10px;"> Dashboard 2</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('dashboard3') }}" class="menu-link">
                    <i class="menu-icon tf-icons mdi mdi-home-outline" style="color: white;"></i>
                    <div style="color: white; margin-left: 10px;"> Dashboard 3</div>
                  </a>
                </li>
                <li class="menu-item sedang-aktif">
                  <a href="{{ route('dashboard4') }}" class="menu-link">
                    <i class="menu-icon tf-icons mdi mdi-home-outline" style="color: white;"></i>
                    <div style="color: white; margin-left: 10px;"> Dashboard 4</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="app-email.html" class="menu-link menu-toggle">
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="app-invoice-list.html" class="menu-link menu-toggle">
                      <i class="menu-icon tf-icons mdi mdi-file-document-outline" style="color: white;"></i>
                      <div style="color: white; margin-left: 10px;">Kode Belanja</div>
                    </a>
                    <ul class="menu-sub">
                      <li class="menu-item">
                        <a href="app-invoice-preview.html" class="menu-link">
                          <i class="menu-icon tf-icons mdi mdi-file-document-outline" style="color: white;"></i>
                          <div style="color: white; margin-left: 10px;">List</div>
                        </a>
                      </li>
                      <li class="menu-item">
                        <a href="app-invoice-preview.html" class="menu-link">
                          <i class="menu-icon tf-icons mdi mdi-file-document-outline" style="color: white;"></i>
                          <div style="color: white; margin-left: 10px;">Add</div>
                        </a>
                      </li>
                      </ul>
                  </li>
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="app-invoice-list.html" class="menu-link menu-toggle">
                      <i class="menu-icon tf-icons mdi mdi-file-document-outline" style="color: white;"></i>
                      <div style="color: white; margin-left: 10px;">Kode SATKER</div>
                    </a>
                    <ul class="menu-sub">
                      <li class="menu-item">
                        <a href="app-invoice-preview.html" class="menu-link">
                          <i class="menu-icon tf-icons mdi mdi-file-document-outline" style="color: white;"></i>
                          <div style="color: white; margin-left: 10px;">Unit Kerja</div>
                        </a>
                      </li>
                      </ul>
                  </li>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <!-- Users List Table -->
                  ...
                  <!-- Table Perbandingan -->
                  <table border="1" style="border: white; width: 100%; text-align: center;">
                    <tr >
                      <th colspan="13" style="position: relative; background-color: #D9D9D9;">Perbandingan Biaya Pengadaan</th>
                    </tr>

                    <br>
                    <tr>
                      <th colspan="1">Program</th>
                      <th colspan="1">Kegiatan</th>
                      <th colspan="1">KRO</th>
                      <th colspan="1">RO</th>
                      <th colspan="1">Detail</th>
                      <th colspan="3">Unit Kerja 2</th>
                    </tr>
                    <tr>
                      <th></th>
                      <th></th>
                      ...
                      <th></th>
                      <th></th>
                      <td rowspan="1" style="text-align: left;">Balai Besar<br>Pengujian Perangkat<br>Telekomunikasi</td>
                      <td rowspan="1" style="text-align: left;">Balai Monitor<br>Spektrum Frekuensi<br>Radio Kelas 1<br>Denpasar</td>
                      <td rowspan="1" style="text-align: left;">Balai Monitor<br>Spektrum Frekuensi<br>Radio Kelas 1<br>Palembang</td>
                    </tr>
                    <tr>
                      <td rowspan="6">Program <br> Dukungan <br> Manager</td>
                      <td rowspan="6">Pengelolaan Keuangan, <br>BUMN dan <br> Umum <br> Direktorat <br> Jendral <br> Sumber <br> Daya dan <br> Perangkat <br> Pos dan <br> Informatika</td>
                      <td rowspan="6">Layanan <br> Dukungan <br> Management <br> Internal <br> (Base Line)</td>
                      <td rowspan="6">Layanan <br> Organisasi <br> dan Tata <br> Kelola Internal</td>
                      <td rowspan="1">Belanja <br> Bahan</td>
                      <td rowspan="1" style="background-color: #40CDFA;">323,308,000</td>
                      <td rowspan="1" style="background-color: #7F889B;">20,118,000</td>
                      <td rowspan="1" style="background-color: #7F889B;">20,400,000</td>
                    <tr>
                        <td rowspan="1">Belanja<br>Bahan Non <br> Operasional<br>- Penanganan<br>Pandemi Covid-19</td>
                        <td rowspan="1" style="background-color: #40CDFA;">432,640,000</td>
                    </tr>
                    <tr>
                      <td rowspan="1">Belanja Non<br>Operasional<br>Lainnya</td>
                      <td rowspan="1" style="background-color: #40CDFA;">406,530,000</td>
                      <td rowspan="1" style="background-color: #7F889B;">2,100,000</td>
                      <td rowspan="1" style="background-color: #7F889B;">177,706,000</td>
                  </tr>
                  <tr>
                    <td rowspan="1">Belanja<br>Bahan Non <br> Operasional<br>- Penanganan<br>Pandemi Covid-19</td>
                    <td rowspan="1" style="background-color: #787EFF;">1,951,632,000</td>
                    <td rowspan="1" style="background-color: #7F889B;">99,000,000</td>
                    <td rowspan="1" style="background-color: #7F889B;">148,704,000</td>
                </tr>
                <tr>
                  <td rowspan="1">Belanja<br>Jasa<br>Konsultan</td>
                  <td rowspan="1" style="background-color: #787EFF;">5,918,517,000</td>
                  <td rowspan="1"></td>
              </tr>
              </tr>
                </table>
