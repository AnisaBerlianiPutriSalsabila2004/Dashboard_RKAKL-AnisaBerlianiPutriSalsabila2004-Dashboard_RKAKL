                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                      ...
                      <li class="menu-item">
                        <a href="{{ route('listdash') }}" class="menu-link">
                          <i class="menu-icon tf-icons mdi mdi-file-document-outline" style="color: white;"></i>
          ...
          <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex mt-3">
                    ...
                    <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#animationModal">
                      Launch modal
                    </button>

                    <!-- Modal -->
                    <div class="modal fade animate__animated fadeIn" id="animationModal" tabindex="-1" aria-hidden="true" style="display: none;">
