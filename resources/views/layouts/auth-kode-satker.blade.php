                              ...
                              <form>
                                  <div class="col-md-6">
                                    <div class="row">
                                      ...
                                      <label class="col-sm-4 col-form-label" style="margin-left: -40px;">Tahun Anggaran*</label>
                                      <div class="col" style="padding-right: 268px;">
                                  ...
                                  <div class="mb-3 row ms-1">
                                    <div class="col-md-6">
                                      <div class="row">
                                      <img src="hai.png" class="ha">
                                      <label class="col-sm-3 col-form-label" style="margin-left: -15px;">Judul Laporan</label>
                                      <div class="col">
                                  ...
                                  <div class="col-md-8">
                                    <div class="row">
                                      <img src="hai.png" class="ha">
                                      <label class="col-sm-3 col-form-label" style="margin-left: -46px;">Tempat/Tanggal</label>
                                      <div class="col-sm-4" style="padding-right: 8px; margin-left: 10px;">
                                        <select id="collapsible-state" class="select2 form-select" data-allow-clear="true">
                                  ...
                                  <!-- <div class="mb-3 row"> -->
                                    <div class="col-md-8 mb-4">
                                        <div class="row">
                                          <img src="hai.png" class="ha">
                                          <label class="col-sm-3 col-form-label" style="margin-left: -36px;">Rincian Anggaran</label>
                                          <div class="col">
                                            <input
                                              type="text"
                                              id="collapsible-fullname"
                                  ...
                                  <div class="col-md-8">
                                    <div class="row">
                                      <img src="hai.png" class="ha">
                                      <label class="col-sm-3 col-form-label" style="margin-left: -42px;">Penanda Tangan</label>
                                      <div class="col-sm-4" style="padding-right: 8px; margin-left: 10px;">
                                      <input
                                              type="text"
                                              id="collapsible-fullname"
