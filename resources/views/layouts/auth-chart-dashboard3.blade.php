...
$tujuan_url = "http://127.0.0.1:8000/dashboard3";
?>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <!-- Users List Table -->
                  ...
                  <table border="1" style="border: white; width: 100%; text-align: center;">
                    ...
                    <br>
                    <tr>
                      <th colspan="1">Unit Kerja 2</th>
                      <th colspan="1">Program</th>
                      <th colspan="1">Kegiatan</th>
                      <th colspan="1">KRO</th>
                      <th colspan="1">RO</th>
                      <th colspan="1">Detail</th>
                      <th colspan="1">Detail 2</th>
                    ...
                    <tr>
                      ...
                      <th></th>
                      <th></th>
                      <th rowspan="1" style="text-align: left; ">2022</th>
                      <th rowspan="1" style="text-align: left;">2023</th>
                    </tr>
                    <tr>
                      <td rowspan="6">Balai Besar <br> Pengujian <br> Perangkat <br> Telekomunikasi</td>
                      <td rowspan="6" style="margin-right: 10px;">Program <br> Dukungan <br> Management</td>
                      ...
                      <td rowspan="6">Belanja <br> Bahan</td>
                      <td rowspan="1">ATK</td>
                      <td rowspan="1" style="background-color: #40CDFA;"></td>
                      <td rowspan="1" style="background-color: #787EFF;">37,388,000</td>
                    <tr>
                        <td rowspan="1">ATK Snack,<br>Makan,<br>Penjilidan<br>Dokumen<br>Rencana<br>dan<br>Program</td>
                        <td rowspan="1" style="background-color: #40CDFA;">4,360,000</td>
                    </tr>
                    <tr>
                      <td rowspan="1">ATK,<br>Bahan,<br>Snack<br>Rapa/<br>Makan</td>
                      <td rowspan="1" style="background-color: #787EFF;">11,940,000</td>
                      <td rowspan="1" style="background-color: #787EFF;">10,560,000</td>
                  </tr>
                  <tr>
                    <td rowspan="1">ATK, Snack,<br>Makan</td>
                    <td rowspan="1" style="background-color: #40CDFA;">2,000,000</td>
                    <td rowspan="1" style="background-color: #7F889B;">7,875,000</td>
                </tr>
                <tr>
                  <td rowspan="1">ATK, Snack,<br>Makan<br>Penyusunan<br>Dokumen<br>Evaluasi<br>dan<br>Monitoring<br>Kegiatan<br>BBPPPT</td>
                  <td rowspan="1" style="background-color: #787EFF;">10,945,000</td>
                  <td rowspan="1"></td>
              </tr>
              </tr>
                </table>
