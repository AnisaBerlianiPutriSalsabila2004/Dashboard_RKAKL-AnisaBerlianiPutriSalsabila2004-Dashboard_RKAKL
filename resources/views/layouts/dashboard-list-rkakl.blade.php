        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1 sayang">
            ...
            <li class="menu-item active open">
              <a href="javascript:void(0);" class="menu-link menu-toggle" style="background-color: #EAEAFF14; margin-top: 10px;">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group">
                            <button class="btn btn-secondary buttons-collection dropdown-toggle btn-label-primary me-2" tabindex="0" aria-controls="DataTables_Table_0" type="button" aria-haspopup="dialog" aria-expanded="false"><span><i class="mdi mdi-export-variant me-sm-1"></i> <span class="d-none d-sm-inline-block">Export</span></span><span class="dt-down-arrow"></span></button></div>
                            <button class="btn btn-secondary create-new btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button">
                                ...
                                <span href="{{ route('kodebelanja') }}" class="d-none d-sm-inline-block">Add Shop Code</span></span>
                            </button>
                        </div>
                    </div>
                  ...
                  <table border="1" style="border: white; width: 100%; text-align: center;">
                    <br>
                    <tr>
                      <th colspan="1" style="background-color: #D9D9D9;">KODE UNIT KERJA</th>
                      <th colspan="1" style="background-color: #D9D9D9;">KODE KEGIATAN</th>
                      <th colspan="1" style="background-color: #D9D9D9;">NAMA KEGIATAN</th>
                      <th colspan="1" style="background-color: #D9D9D9;">KODE KOMPONEN</th>
                      <th colspan="1" style="background-color: #D9D9D9;">NAMA KOMPONEN</th>
                      <th colspan="1" style="background-color: #D9D9D9;">KODE KRO</th>
                    </tr>
                    <tr>
                      <td rowspan="1">417638</td>
                      <td rowspan="1" style="margin-right: 10px;">6492</td>
                      <td rowspan="1">Monitoring dan Pengendalian Spektrum Fr</td>
                      <td rowspan="1">100</td>
                      <td rowspan="1">SBML</td>
                      <td rowspan="1">BAH</td>
                    <tr>
                        <td rowspan="1">417638</td>
                        <td rowspan="1">6492</td>
                        <td rowspan="1">Monitoring dan Pengendalian Spektrum Fr</td>
                        <td rowspan="1">101</td>
                        <td rowspan="1">Dukungan Tupoksi</td>
                        <td rowspan="1">BAH</td>
                    </tr>
                    <tr>
                      <td rowspan="1">417638</td>
                      ...
                      <td rowspan="1">Monitoring dan Pengendalian Spektrum Fr</td>
                      <td rowspan="1">102</td>
                      <td rowspan="1">Peningkatan Sarana Prasarana</td>
                      <td rowspan="1">BAH</td>
                  </tr>
                  <tr>
                    <td rowspan="1">417638</td>
                ...
                <tr>
                  ...
                  <td rowspan="1">Monitoring dan Pengendalian Spektrum Fr</td>
                  <td rowspan="1">104</td>
                  <td rowspan="1">Persiapan Kegiatan</td>
                  <td rowspan="1">BAH</td>
              </tr>
              <tr>
                  <td rowspan="1">417638</td>
                  ...
                  <td rowspan="1">Monitoring dan Pengendalian Spektrum Fr</td>
                  <td rowspan="1">105</td>
                  <td rowspan="1">Pelaksanaan Kegiatan</td>
                  <td rowspan="1">BAH</td>
              </tr>
              <tr>
                  <td rowspan="1">417638</td>
